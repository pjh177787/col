...
os.environ["CUDA_VISIBLE_DEVICES"]=input("choose GPU 0/1:")
...
model_name = 'model_'+model_number+"_"+mode
...
sample_w = [1.0,1.0]
if(train_test == '1'):
	my_generator = DataGenerator(mode,"_test",sample_w,train_id, audio_len,kernel_width, **train_params)
else:
	my_generator = DataGenerator(mode,"_test",sample_w,test_id,audio_len,kernel_width, **test_params)
...
for i_batch in range(num_batch):
	...
	batch_pred = copy.deepcopy(y_pred_0)/1
	...
	output_labels, predict_event_list = event_list_gen(y_pred_comb,0.6,15)
